...
- Add a complete environment variable reference with defaults
- Add sample request/response payloads for key API endpoints
- Add deployment notes for production (TLS, reverse proxy, secrets)
- Add monitoring/observability guidance for MQTT and telemetry pipelines
